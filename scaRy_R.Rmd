...
Learning `R`, like any other programming language, is normally received by learners (especially those with _zero_ background in programming) with awe. Why? Because the training normally comes from seasoned users, who have used the program for a long time that they overlook basics that a new user should grasp while stepping into `R`. 
